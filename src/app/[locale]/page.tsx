            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-wrap justify-center items-center gap-x-[24px] gap-y-[40px] my-[64px]">
                {excursionsData && excursionsData.map((elm) => {
                  ...
                  return <div key={elm.id} className="shadow-xl/50 rounded-lg  overflow-hidden">
                    <Card
                      stylesOfCard="relative w-[200px] h-[300px] lg:w-[300px] lg:h-[400px] flex flex-col items-start justify-end gap-[8px] p-[12px] lg:p-[24px] cursor-pointer group transition-all duration-500 hover:scale-110"
                      bgImage={elm.img}
