...
export default function AsideCard() {
    ...
    return <div className="bg-primary flex flex-col p-[32px] w-[350px] rounded-[10px]">
        <div className="flex flex-col gap-[6px]">
            <span className="text-[14px] font-[400] leading-[143%] text-secondary/50">{t("From")}</span>
            ...
            <p className="text-[14px] font-[400] leading-[143%] text-accent">{t("BestPrice")}</p>
        </div>
        <hr className="my-[24px]" />
        <h5 className="text-[18px] font-[500] leading-[156%] text-secondary mb-[17px]">{t("Breakdown")}</h5>
        <div className="w-full flex justify-between items-center">
            <div className="w-full flex flex-col gap-[12px]">
                <p className="text-[14px] font-[400] leading-[143%] text-secondary/50">{t("BasePrice")}</p>
                <p className="text-[14px] font-[400] leading-[143%] text-secondary/50">{t("Accommodations")}</p>
                <p className="text-[14px] font-[400] leading-[143%] text-secondary/50">{t("GuidedTours")}</p>
            </div>
        ...
        <div className="w-full flex justify-between items-center">
            <p className="text-[18px] font-[400] leading-[156%] text-secondary">{t("Total")}</p>
