...
export function TourDetail({ tour }: Props) {
  ...
  return (
    <div className="bg-gray-950 mt-20">
        ...
        <main className="mx-auto px-[20px] py-[32px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {tour?.highlights?.map((item, idx: number) => (
                      <div key={idx} className="flex items-center gap-3">
                        ...
                        <span className="text-[16px] font-[400] leading-[163%] text-secondary space-y-4 whitespace-pre-line text-base">{item.text}</span>
                      </div>
                    ))}
                  </div>
                </div>
                      ...
                      tour?.tourPlan?.map((item, idx: number) => (
                        <div key={idx} className="flex gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-[16px] font-[400] leading-[150%] text-secondary/50 space-y-4 whitespace-pre-line text-base">{item?.description}</p>
                          </div>
                        </div>
                      ))}
                  </div>
              ...
              <div className="bg-secondary/2 border border-dark-gray/50 rounded-2xl p-8 transition-all hover:border-gray-700">
                <h2 className="text-[24px] font-[700] leading-[133%] text-secondary mb-6">{t("Reviews")}</h2>
                <div className="space-y-6">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24">
                <div className="bg-secondary/2 border border-dark-gray/50 rounded-[16px] p-8 transition-all hover:border-dark-gray">
                  <div className="mb-6">
                    <div className="text-secondary/50 text-[14px] font-[400] leading-[143%] mb-2">{t("PriceFrom")}</div>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="relative">
                      ...
                      <div className="pointer-events-none absolute w-[10px] h-[10px] right-4 top-[60%] -translate-y-1/2 text-accent">▼</div>
                  ...
                  <div className="border-t border-gray-700 pt-6 space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-[14px] font-[400] leading-[143%]">
                      <Check className="w-5 h-5 text-green-500" />
                      <span className="text-secondary/80">{t("ElectronicTicket")}</span>
                    </div>
                    <div className="flex items-center gap-3 text-[14px] font-[400] leading-[143%]">
                      <Check className="w-5 h-5 text-green-500" />
                      <span className="text-secondary/80">{t("RussianSpeakingGuide")}</span>
                    </div>
                  </div>
                </div>
      ...
      {/* <footer className="bg-gray-900/50 border-t border-dark-gray mt-20">
